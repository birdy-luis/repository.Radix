...
INSTALL_PAGE     = base64.b64decode(b'aHR0cDovL2FzazRhY2Nlc3MuY29tL21lbWJlcnMvY2hlY2sucGhw')
MEMBERS_URL      = base64.b64decode(b'aHR0cDovL2FzazRhY2Nlc3MuY29tL21lbWJlcnM=')
WIZARD_PAGE      = base64.b64decode(b'aHR0cDovL2FzazRhY2Nlc3MuY29tL21lbWJlcnN3aXphcmQucGhw')
...
def index():
	if AUTOUPDATE == 'Yes':
		if wiz.workingURL(WIZARDFILE) == True:
			...
			if ver > VERSION: addFile('%s [v%s] [COLOR red][B][UPDATE v%s][/B][/COLOR]' % (ADDONTITLE, VERSION, ver), 'updates', themeit=THEME2)
	...
	#
	#Main menu        edited by @ShaneysRepo  ####
    #    
	if HIDESPACERS == 'No': 
		addFile('[COLOR red][B]=[COLOR white][B]=[COLOR blue][B]=[COLOR red][B]=[COLOR white][B]=[COLOR blue][B]=[COLOR red][B]=[COLOR white][B]=[COLOR blue][B]=[COLOR red][B]=[COLOR white][B]=[COLOR blue][B]=[COLOR red][B]=[COLOR white][B]=[COLOR blue][B]=[COLOR red][B]=[COLOR white][B]=[COLOR blue][B]=[COLOR red][B]=[COLOR white][B]=[COLOR blue][B]=[COLOR red][B]=[COLOR white][B]=[COLOR blue][B]=[COLOR red][B]=[COLOR white][B]=[COLOR blue][B]=[COLOR red][B]=[COLOR white][B]=[COLOR blue][B]=[COLOR red][B]=[COLOR white][B]=[COLOR blue][B]=[COLOR red][B]=[COLOR white][B]=[COLOR blue][B]=[COLOR red][B]=[COLOR white][B]=[COLOR blue][B]=[COLOR red][B]=[/B][/COLOR]', '', themeit=THEME3)
	addDir ('[COLOR white]-        Go to updates[/COLOR] [COLOR red][B] [YOU MUST BE LOGGED IN TO UPDATE][/B][/COLOR]'        ,'builds',   icon=ICONBUILDS,   themeit=THEME1)
	addDir ('[COLOR white]-        Maintenance[/COLOR]'   ,'maint',    icon=ICONMAINT,    themeit=THEME1)
	addDir ('[COLOR white]-        Android app Installer[/COLOR]' ,'apk', icon=ICONAPK, themeit=THEME1)
	addFile('[COLOR white]-        More information[/COLOR]' ,'contact', icon=ICONCONTACT,  themeit=THEME1)
	addFile('[COLOR white]-        Go to Settings[/COLOR]'      ,'settings', icon=ICONSETTINGS, themeit=THEME1)
	addFile('[COLOR red][B]=[COLOR white][B]=[COLOR blue][B]=[COLOR red][B]=[COLOR white][B]=[COLOR blue][B]=[COLOR red][B]=[COLOR white][B]=[COLOR blue][B]=[COLOR red][B]=[COLOR white][B]=[COLOR blue][B]=[COLOR red][B]=[COLOR white][B]=[COLOR blue][B]=[COLOR red][B]=[COLOR white][B]=[COLOR blue][B]=[COLOR red][B]=[COLOR white][B]=[COLOR blue][B]=[COLOR red][B]=[COLOR white][B]=[COLOR blue][B]=[COLOR red][B]=[COLOR white][B]=[COLOR blue][B]=[COLOR red][B]=[COLOR white][B]=[COLOR blue][B]=[COLOR red][B]=[COLOR white][B]=[COLOR blue][B]=[COLOR red][B]=[COLOR white][B]=[COLOR blue][B]=[COLOR red][B]=[COLOR white][B]=[COLOR blue][B]=[COLOR red][B]=[/B][/COLOR]', '', themeit=THEME3)
	#addFile('[COLOR red][B]=[COLOR white][B]=[COLOR blue][B]=[COLOR red][B]=[COLOR white][B]=[COLOR blue][B]=[COLOR red][B]=[COLOR white][B]=[COLOR blue][B]=[COLOR red][B]=[COLOR white][B]=[COLOR blue][B]=[COLOR red][B]=[COLOR white][B]=[COLOR blue][B]=[COLOR red][B]=[COLOR white][B]=[COLOR blue][B]=[COLOR red][B]=[COLOR white][B]=[COLOR blue][B]=[COLOR red][B]=[COLOR white][B]=[COLOR blue][B]=[COLOR red][B]=[COLOR white][B]=[COLOR blue][B]=[COLOR red][B]=[COLOR white][B]=[COLOR blue][B]=[COLOR red][B]=[COLOR white][B]=[COLOR blue][B]=[COLOR red][B]=[COLOR white][B]=[COLOR blue][B]=[COLOR red][B]=[COLOR white][B]=[COLOR blue][B]=[COLOR red][B]=[/B][/COLOR]', '', fanart=FANART, icon=ICONMAINT, themeit=THEME3)
	#if HIDESPACERS == 'No': addFile('[B][COLOR blue]-       www.KodiAddons.uk         -[/COLOR][/B]', '', themeit=THEME3)
	if DEVELOPER == 'true': addDir('[COLOR red][B]Developer Menu = Advanced Users Only[/B][/COLOR]','developer', icon=ICONSETTINGS, themeit=THEME1)
	addFile('[COLOR red][B]=[COLOR white][B]=[COLOR blue][B]=[COLOR red][B]=[COLOR white][B]=[COLOR blue][B]=[COLOR red][B]=[COLOR white][B]=[COLOR blue][B]=[COLOR red][B]=[COLOR white][B]=[COLOR blue][B]=[COLOR red][B]=[COLOR white][B]=[COLOR blue][B]=[COLOR red][B]=[COLOR white][B]=[COLOR blue][B]=[COLOR red][B]=[COLOR white][B]=[COLOR blue][B]=[COLOR red][B]=[COLOR white][B]=[COLOR blue][B]=[COLOR red][B]=[COLOR white][B]=[COLOR blue][B]=[COLOR red][B]=[COLOR white][B]=[COLOR blue][B]=[COLOR red][B]=[COLOR white][B]=[COLOR blue][B]=[COLOR red][B]=[COLOR white][B]=[COLOR blue][B]=[COLOR red][B]=[COLOR white][B]=[COLOR blue][B]=[COLOR red][B]=[/B][/COLOR]', '', fanart=FANART, icon=ICONMAINT, themeit=THEME3)
	setView('files', 'MAIN')
	#
	####     Build Menu     edited by @ShaneysRepo ####
	#
def buildMenu():
	suminstall()
	if HIDESPACERS == 'No': addFile('                       -     [COLOR red]K[/COLOR][COLOR white]O[/COLOR][COLOR blue]D[/COLOR][COLOR red]I-[/COLOR][COLOR white]A[/COLOR][COLOR blue]D[/COLOR][COLOR red]D[/COLOR][COLOR white]O[/COLOR][COLOR blue]N[/COLOR][COLOR red]S-[/COLOR][COLOR white]U[/COLOR][COLOR blue]K[/COLOR][COLOR white] Installer[/COLOR]    -', '', themeit=THEME3)
	if not WORKINGURL == True:
		addFile('                    [COLOR red]Logged in using %s Version:[/COLOR][COLOR white][B] %s[/B][/COLOR]' % (MCNAME, KODIV), '', icon=ICONBUILDS, themeit=THEME3)
		addFile('[B][COLOR white][COLOR red][B]=[COLOR white][B]=[COLOR blue][B]=[COLOR red][B]=[COLOR white][B]=[COLOR blue][B]=[COLOR red][B]=[COLOR white][B]=[COLOR blue][B]=[COLOR red][B]=[COLOR white][B]=[COLOR blue][B]=[COLOR red][B]=[COLOR white][B]=[COLOR blue][B]=[COLOR red][B]=[COLOR white][B]=[COLOR blue][B]=[COLOR red][B]=[COLOR white][B]=[COLOR blue][B]=[COLOR red][B]=[COLOR white][B]=[COLOR blue][B]=[COLOR red][B]=[COLOR white][B]=[COLOR blue][B]=[COLOR red][B]=[COLOR white][B]=[COLOR blue][B]=[COLOR red][B]=[/B][/COLOR][/COLOR][/B]', '', themeit=THEME3)
		addFile('KodiAddons is being an idiot! contact me to sort it out :-)', '', icon=ICONBUILDS, themeit=THEME3)
		addFile('quote: "The update files are not loading"', '', icon=ICONBUILDS, themeit=THEME3)
		addFile('%s' % WORKINGURL, '', icon=ICONBUILDS, themeit=THEME3)
		addFile('[B][COLOR white][COLOR red][B]=[COLOR white][B]=[COLOR blue][B]=[COLOR red][B]=[COLOR white][B]=[COLOR blue][B]=[COLOR red][B]=[COLOR white][B]=[COLOR blue][B]=[COLOR red][B]=[COLOR white][B]=[COLOR blue][B]=[COLOR red][B]=[COLOR white][B]=[COLOR blue][B]=[COLOR red][B]=[COLOR white][B]=[COLOR blue][B]=[COLOR red][B]=[COLOR white][B]=[COLOR blue][B]=[COLOR red][B]=[COLOR white][B]=[COLOR blue][B]=[COLOR red][B]=[COLOR white][B]=[COLOR blue][B]=[COLOR red][B]=[COLOR white][B]=[COLOR blue][B]=[COLOR red][B]=[/B][/COLOR][/COLOR][/B]', '', icon=ICONBUILDS, themeit=THEME3)
		addFile('[B][COLOR blue]Twitter: @irlamuk      |         Web: kodiaddons.uk[/COLOR][/B]', '', icon=ICONBUILDS, themeit=THEME3)
	else:	
		...
		if len(match) == 1:
			...
			addFile('               [COLOR red]You Are Logged In And Using %s Version:[/COLOR][COLOR white][B] %s[/B][/COLOR]' % (MCNAME, KODIV), '', icon=ICONBUILDS, themeit=THEME3)
			if HIDESPACERS == 'No': addFile('[COLOR white][B]                       -       Select a Build to install       -[/B][/COLOR]', '', themeit=THEME3)
			#addDir ('Save Data Menu'       ,'savedata', icon=ICONSAVE,     themeit=THEME3)
			if HIDESPACERS == 'No': addFile('[B][COLOR white][COLOR red][B]=[COLOR white][B]=[COLOR blue][B]=[COLOR red][B]=[COLOR white][B]=[COLOR blue][B]=[COLOR red][B]=[COLOR white][B]=[COLOR blue][B]=[COLOR red][B]=[COLOR white][B]=[COLOR blue][B]=[COLOR red][B]=[COLOR white][B]=[COLOR blue][B]=[COLOR red][B]=[COLOR white][B]=[COLOR blue][B]=[COLOR red][B]=[COLOR white][B]=[COLOR blue][B]=[COLOR red][B]=[COLOR white][B]=[COLOR blue][B]=[COLOR red][B]=[COLOR white][B]=[COLOR blue][B]=[COLOR red][B]=[COLOR white][B]=[COLOR blue][B]=[COLOR red][B]=[/B][/COLOR]=[COLOR white][B]=[COLOR blue][B]=[COLOR red][B]=[COLOR white][B]=[COLOR blue][B]=[COLOR red][B]=[/B][/COLOR]', '', themeit=THEME3)
			if SEPERATE == 'true':
				...
				if count16 > 0:
					...
					if SHOW16 == 'true':
						for name, version, url, kodi, icon, fanart in match:
							...
							if kodiv >= 16:
								menu = createMenu('install', '', name)
								#  Edited by @ShaneysRepo
								addDir('For version:[COLOR white][%s][/COLOR] [COLOR white][B] %s [/B]  (v%s)[/COLOR]' % (float(kodi), name, version),'viewbuild',name,fanart=fanart,icon=icon, menu=menu, themeit=THEME2)
				if count15 > 0:
					if count16 > 0:
...
def suminstall(redo=False):
	if wiz.getS('login') == '' or wiz.getS('pass') == '' or redo == True:
		...
		else: choice = DIALOG.yesno(ADDONTITLE, "You are required to login to install updates %s!" % ADDONTITLE, "Would you like to enter in your login information?", "Visit %s to Register!" % MEMBERS_URL, yeslabel="Enter Details", nolabel="No Cancel")
		if choice == 1: 
	...
	try:
		...
		if DIALOG.yesno('Authentication Failure\n Please check You Have Enterd The Correct Login Details', 'If You Have Not Registerd For your Login Please signup here: http://www.kodiaddons.uk/members', 'Then Enter Your the details', yeslabel="Re-Enter Details", nolabel="No Cancel"):
			suminstall(True)
		else:
			sys.exit()
...
def viewBuild(name):
	...
	if wiz.checkBuild(name, 'version') == False: 
		addFile('You are [COLOR lime]Logged in[/COLOR][COLOR white] but...[/COLOR]', '', themeit=THEME3)
		addFile('[COLOR red][B]=[COLOR white][B]=[COLOR blue][B]=[COLOR red][B]=[COLOR white][B]=[COLOR blue][B]=[COLOR red][B]=[COLOR white][B]=[COLOR blue][B]=[COLOR red][B]=[COLOR white][B]=[COLOR blue][B]=[COLOR red][B]=[COLOR white][B]=[COLOR blue][B]=[COLOR red][B]=[COLOR white][B]=[COLOR blue][B]=[COLOR red][B]=[COLOR white][B]=[COLOR blue][B]=[COLOR red][B]=[COLOR white][B]=[COLOR blue][B]=[COLOR red][B]=[COLOR white][B]=[COLOR blue][B]=[COLOR red][B]=[COLOR white][B]=[COLOR blue][B]=[COLOR red][B]=[/B][/COLOR]', '', themeit=THEME3)
		addFile('kodiaddons.uk being an idiot again!', '', themeit=THEME3)
		addFile('quote: "There is a simple error with Wizard.txt"', '', themeit=THEME3)
		addFile('Please contact him and tell him to sort it out!!', '', themeit=THEME3)
		addFile('%s was not found in the builds list.' % name, '', themeit=THEME3)
		addFile('[COLOR red][B]=[COLOR white][B]=[COLOR blue][B]=[COLOR red][B]=[COLOR white][B]=[COLOR blue][B]=[COLOR red][B]=[COLOR white][B]=[COLOR blue][B]=[COLOR red][B]=[COLOR white][B]=[COLOR blue][B]=[COLOR red][B]=[COLOR white][B]=[COLOR blue][B]=[COLOR red][B]=[COLOR white][B]=[COLOR blue][B]=[COLOR red][B]=[COLOR white][B]=[COLOR blue][B]=[COLOR red][B]=[COLOR white][B]=[COLOR blue][B]=[COLOR red][B]=[COLOR white][B]=[COLOR blue][B]=[COLOR red][B]=[COLOR white][B]=[COLOR blue][B]=[COLOR red][B]=[/B][/COLOR]', '', themeit=THEME3)
		addFile('[B][COLOR blue]Twitter: @irlamuk      |         WEB: www.kodiaddons.uk[/COLOR][/B] ', '', themeit=THEME3)
		return
	link = wiz.openURL(BUILDFILE).replace('\n','').replace('\r','').replace('\t','')
	...
	for version, url, gui, kodi, themefile, icon, fanart in match:
		...
		build       = '[COLOR white] Options for:[/COLOR] %s (v%s) [COLOR white]updates[/COLOR]' % (name, version)
		...
		if KODIV < 16 and float(kodi) >= 16:
			addFile('[I]This Update is designed for kodi version %s(installed: %s)[/I]' % (str(kodi), str(KODIV)), '', fanart=fanart, icon=icon, themeit=THEME3)
		addFile('[COLOR lime]You Are Logged in[/COLOR]', '', fanart=fanart, icon=icon, themeit=THEME3)
		addFile('[B][COLOR white][COLOR red][B]=[COLOR white][B]=[COLOR blue][B]=[COLOR red][B]=[COLOR white][B]=[COLOR blue][B]=[COLOR red][B]=[COLOR white][B]=[COLOR blue][B]=[COLOR red][B]=[COLOR white][B]=[COLOR blue][B]=[COLOR red][B]=[COLOR white][B]=[COLOR blue][B]=[COLOR red][B]=[COLOR white][B]=[COLOR blue][B]=[COLOR red][B]=[COLOR white][B]=[COLOR blue][B]=[COLOR red][B]=[COLOR white][B]=[COLOR blue][B]=[COLOR red][B]=[COLOR white][B]=[COLOR blue][B]=[COLOR red][B]=[COLOR white][B]=[COLOR blue][B]=[COLOR red][B]=[/B][/COLOR]', '', fanart=fanart, icon=icon, themeit=THEME3)
		addFile('[COLOR white]-             Click Here To Install This update            -[/COLOR]'   , 'install', name, 'fresh'   , fanart=fanart, icon=icon, themeit=THEME1)
		addFile('[COLOR red][B]=[COLOR white][B]=[COLOR blue][B]=[COLOR red][B]=[COLOR white][B]=[COLOR blue][B]=[COLOR red][B]=[COLOR white][B]=[COLOR blue][B]=[COLOR red][B]=[COLOR white][B]=[COLOR blue][B]=[COLOR red][B]=[COLOR white][B]=[COLOR blue][B]=[COLOR red][B]=[COLOR white][B]=[COLOR blue][B]=[COLOR red][B]=[COLOR white][B]=[COLOR blue][B]=[COLOR red][B]=[COLOR white][B]=[COLOR blue][B]=[COLOR red][B]=[COLOR white][B]=[COLOR blue][B]=[COLOR red][B]=[COLOR white][B]=[COLOR blue][B]=[COLOR red][B]=[/B][/COLOR]', '', fanart=fanart, icon=icon, themeit=THEME3)
		#addFile('[COLOR white]-        Update[/COLOR]', 'install', name, 'normal'  , fanart=fanart, icon=icon, themeit=THEME1)
		#addFile('[COLOR red][B]=[COLOR white][B]=[COLOR blue][B]=[COLOR red][B]=[COLOR white][B]=[COLOR blue][B]=[COLOR red][B]=[COLOR white][B]=[COLOR blue][B]=[COLOR red][B]=[COLOR white][B]=[COLOR blue][B]=[COLOR red][B]=[COLOR white][B]=[COLOR blue][B]=[COLOR red][B]=[COLOR white][B]=[COLOR blue][B]=[COLOR red][B]=[COLOR white][B]=[COLOR blue][B]=[COLOR red][B]=[COLOR white][B]=[COLOR blue][B]=[COLOR red][B]=[COLOR white][B]=[COLOR blue][B]=[COLOR red][B]=[COLOR white][B]=[COLOR blue][B]=[COLOR red][B]=[/B][/COLOR]', '', fanart=fanart, icon=icon, themeit=THEME3)
		#addFile('[B][COLOR white]Fixes and other options:[/COLOR][/B]', '', fanart=fanart, icon=icon, themeit=THEME3)
		...
		if APKWORKINGURL == True:
			...
			if len(match) > 0:
				for name, url, icon, fanart in match:
					addFile(name, 'Android apps Installer', name, url, icon=icon, fanart=fanart, themeit=THEME1)
...
def maintMenu():
	...
	addFile('[COLOR blue][B]=[COLOR red][B]=[COLOR white][B]=[COLOR blue][B]=[COLOR red][B]=[COLOR white][B]=[COLOR blue][B]=[COLOR red][B]=[COLOR white][B]=[COLOR blue][B]=[COLOR red][B]=[COLOR white][B]=[COLOR blue][B]=[COLOR red][B]=[/B][/COLOR][COLOR white][B][ TOOLS ][COLOR red][B]=[COLOR white][B]=[COLOR blue][B]=[COLOR red][B]=[COLOR white][B]=[COLOR blue][B]=[COLOR red][B]=[COLOR white][B]=[COLOR blue][B]=[COLOR red][B]=[COLOR white][B]=[COLOR blue][B]=[COLOR red][B]=[COLOR white][B]=[COLOR blue][B]=[/B][/COLOR]', '', fanart=FANART, icon=ICONMAINT, themeit=THEME3)
	...
	addFile('[COLOR blue][B]=[COLOR red][B]=[COLOR white][B]=[COLOR blue][B]=[COLOR red][B]=[COLOR white][B]=[COLOR blue][B]=[COLOR red][B]=[COLOR white][B]=[COLOR blue][B]=[COLOR red][B]=[COLOR white][B]=[COLOR blue][B]=[COLOR red][B]=[/B][/COLOR][COLOR white][B][ Auto Clean ][COLOR red][B]=[COLOR white][B]=[COLOR blue][B]=[COLOR red][B]=[COLOR white][B]=[COLOR blue][B]=[COLOR red][B]=[COLOR white][B]=[COLOR blue][B]=[COLOR red][B]=[COLOR white][B]=[COLOR blue][B]=[COLOR red][B]=[COLOR white][B]=[COLOR blue][B]=[/B][/COLOR]', '', fanart=FANART, icon=ICONMAINT, themeit=THEME3)
...
def loginMenu():
	...
	addFile('[I]SOME of these addons are PAID services.[/I]', '', icon=ICONLOGIN, themeit=THEME3)
...
def developer():
	addFile('[COLOR blue][B]=[COLOR red][B]=[COLOR white][B]=[COLOR blue][B]=[COLOR red][B]=[COLOR white][B]=[COLOR blue][B]=[COLOR red][B]=[COLOR white][B]=[COLOR blue][B]=[COLOR red][B]=[COLOR white][B]=[COLOR blue][B]=[COLOR red][B]=[/B][/COLOR][COLOR white][B][ BACKUP ][COLOR red][B]=[COLOR white][B]=[COLOR blue][B]=[COLOR red][B]=[COLOR white][B]=[COLOR blue][B]=[COLOR red][B]=[COLOR white][B]=[COLOR blue][B]=[COLOR red][B]=[COLOR white][B]=[COLOR blue][B]=[COLOR red][B]=[COLOR white][B]=[COLOR blue][B]=[/B][/COLOR]', '',    themeit=THEME3)
	...
	addFile('[COLOR blue][B]=[COLOR red][B]=[COLOR white][B]=[COLOR blue][B]=[COLOR red][B]=[COLOR white][B]=[COLOR blue][B]=[COLOR red][B]=[COLOR white][B]=[COLOR blue][B]=[COLOR red][B]=[COLOR white][B]=[COLOR blue][B]=[COLOR red][B]=[/B][/COLOR][COLOR white][B][ RESTORE ][COLOR red][B]=[COLOR white][B]=[COLOR blue][B]=[COLOR red][B]=[COLOR white][B]=[COLOR blue][B]=[COLOR red][B]=[COLOR white][B]=[COLOR blue][B]=[COLOR red][B]=[COLOR white][B]=[COLOR blue][B]=[COLOR red][B]=[COLOR white][B]=[COLOR blue][B]=[/B][/COLOR]', '',    themeit=THEME3)
	...
	addFile('[COLOR blue][B]=[COLOR red][B]=[COLOR white][B]=[COLOR blue][B]=[COLOR red][B]=[COLOR white][B]=[COLOR blue][B]=[COLOR red][B]=[COLOR white][B]=[COLOR blue][B]=[COLOR red][B]=[COLOR white][B]=[COLOR blue][B]=[COLOR red][B]=[/B][/COLOR][COLOR white][B][ FIXES ][COLOR red][B]=[COLOR white][B]=[COLOR blue][B]=[COLOR red][B]=[COLOR white][B]=[COLOR blue][B]=[COLOR red][B]=[COLOR white][B]=[COLOR blue][B]=[COLOR red][B]=[COLOR white][B]=[COLOR blue][B]=[COLOR red][B]=[COLOR white][B]=[COLOR blue][B]=[/B][/COLOR]', '',     themeit=THEME3)
	...
	addFile('[COLOR blue][B]=[COLOR red][B]=[COLOR white][B]=[COLOR blue][B]=[COLOR red][B]=[COLOR white][B]=[COLOR blue][B]=[COLOR red][B]=[COLOR white][B]=[COLOR blue][B]=[COLOR red][B]=[COLOR white][B]=[COLOR blue][B]=[COLOR red][B]=[/B][/COLOR][COLOR white][B][ UPDATE TESTS ][COLOR red][B]=[COLOR white][B]=[COLOR blue][B]=[COLOR red][B]=[COLOR white][B]=[COLOR blue][B]=[COLOR red][B]=[COLOR white][B]=[COLOR blue][B]=[COLOR red][B]=[COLOR white][B]=[COLOR blue][B]=[COLOR red][B]=[COLOR white][B]=[COLOR blue][B]=[/B][/COLOR]', '',    themeit=THEME3)
...
def buildWizard(name, type, theme=None):
	...
	if type == 'gui':
		if name == BUILDNAME:
			...
			yes_pressed=DIALOG.yesno("%s - [COLOR red]WARNING!![/COLOR]" % ADDONTITLE, "%s A kodiAddons.UK build is not currently installed." % name, "Would you like to apply the guiFix anyways?.", yeslabel="Yes, Apply", nolabel="No, Cancel")
		if yes_pressed:
			buildzip = wiz.checkBuild(name,'gui')
			zipname = name.replace('\\', '').replace('/', '').replace(':', '').replace('*', '').replace('?', '').replace('"', '').replace('<', '').replace('>', '').replace('|', '')
			if not wiz.workingURL(buildzip) == True: wiz.LogNotify(ADDONTITLE, 'guiFix: [COLOR red]Invalid Update Url![/COLOR]'); return
		...
		if yes_pressed:
			...
			zipname = name.replace('\\', '').replace('/', '').replace(':', '').replace('*', '').replace('?', '').replace('"', '').replace('<', '').replace('>', '').replace('|', '')
			if not wiz.workingURL(buildzip) == True: wiz.LogNotify(ADDONTITLE, 'Update Install: [COLOR red]Invalid Update Url![/COLOR]'); return
			if not os.path.exists(PACKAGES): os.makedirs(PACKAGES)
		...
		if installtheme:
			...
			zipname = name.replace('\\', '').replace('/', '').replace(':', '').replace('*', '').replace('?', '').replace('"', '').replace('<', '').replace('>', '').replace('|', '')
			if not wiz.workingURL(themezip) == True: wiz.LogNotify(ADDONTITLE, 'Theme Install: [COLOR red]Invalid Update Url![/COLOR]'); return
			if not os.path.exists(PACKAGES): os.makedirs(PACKAGES)
			DP.create(ADDONTITLE,'Downloading %s ' % name,'', 'Please Wait')
			lib=os.path.join(PACKAGES, '%s.zip' % zipname)
			try: os.remove(lib)
...
def createMenu(type, add, name):
	if   type == 'saveaddon':
		...
		menu_items.append((THEME3 % 'Fresh Install < You ALLWAYS Have To Do This Before Updating',          'RunPlugin(plugin://%s/?mode=install&name=%s&url=fresh)'  % (ADDON_ID, name2)))
...
def removeAddon(addon):
	if DIALOG.yesno(ADDONTITLE, 'Are you sure you want to delete this addon:', '[COLOR yellow]%s[/COLOR]' % addon, yeslabel='Yes, Remove', nolabel='No, Cancel'):
...
def freshStart(install=None):
	...
	elif install: yes_pressed=DIALOG.yesno(ADDONTITLE,"You Are About To Install A NEW Update","Do You Want To Continue?", "[COLOR blue]%s[/COLOR]?" % install, nolabel='No, Cancel', yeslabel='Yes,Continue')
	else: yes_pressed=DIALOG.yesno(ADDONTITLE,"We will Now restore your","Current Configuration To The Default Settings Please Select Continue to Install The New Update", nolabel='No, Cancel', yeslabel='Yes, Continue')
	if yes_pressed:
		if not wiz.currSkin() in ['skin.confluence', 'skin.estuary']:
			skin = 'skin.confluence' if KODIV < 17 else 'skin.estuary'
			yes=DIALOG.yesno(ADDONTITLE, "We Need To Change A Few Settings Before Continuing." , "Would you like us to do that for you? Just Click YES !!", yeslabel="Yes, Continue");
			if yes:
		...
		DP.create(ADDONTITLE,"Clearing all OLD files and folders:",'', '')

...
def firstRun(msg='', TxtColor='0xFFFFFFFF', Font='font12', BorderWidth=10):
	class MyWindow(xbmcgui.WindowDialog):
		...
		def __init__(self,L=0,T=0,W=1280,H=720,TxtColor='0xFFFFFFFF',Font='font12',BorderWidth=10):
			...
			self.title.setText(title)
			#welcome message
			msg   = "                                      [COLOR white]Thank you for installing [B]%s.[/B][/COLOR]\n\n    Select 'Log in' to Log in and install a Build 'Ignore' to never see this message again.\n\n    [COLOR red][B]Make sure you have your kodiaddons.uk Account details are Ready[/B][/COLOR]\n\n    Thank you for choosing %s.\n\n           [COLOR white] Credits to: [B]Shaney , Lee TV , Aftermath & Techtimeruu[/B] for Basecode and Help[/COLOR]" % (ADDONTITLE, ADDONTITLE)
			msg   = THEME2 % msg
			...
			self.buttonBUILDMENU=xbmcgui.ControlButton(buildmenu,t,w1,h1,"[B][COLOR white]Log in[/COLOR][/B]",textColor="0xFF000000",focusedColor="0xFF000000",alignment=2,focusTexture=focus,noFocusTexture=nofocus)
